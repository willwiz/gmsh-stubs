...
p1 = gmsh.model.geo.add_point(-0.05, 0.05, 0, lc)
p2 = gmsh.model.geo.add_point(-0.05, 0.1, 0, lc)
l1 = gmsh.model.geo.add_line(1, p1)
l2 = gmsh.model.geo.add_line(p1, p2)
l3 = gmsh.model.geo.add_line(p2, 4)

# Create surface
gmsh.model.geo.add_curve_loop([2, -1, l1, l2, l3, -3], 2)
gmsh.model.geo.add_plane_surface([-2], 1)
...
# points):
gmsh.model.geo.mesh.set_transfinite_curve(2, 20)
...
gmsh.model.geo.mesh.set_transfinite_curve(l1, 6)
gmsh.model.geo.mesh.set_transfinite_curve(l2, 6)
...
gmsh.model.geo.mesh.set_transfinite_curve(1, 30, "Progression", -1.2)
gmsh.model.geo.mesh.set_transfinite_curve(3, 30, "Progression", 1.2)
...
gmsh.model.geo.add_point(0.2, 0.2, 0, 1.0, 7)
gmsh.model.geo.add_point(0.2, 0.1, 0, 1.0, 8)
gmsh.model.geo.add_point(0.25, 0.2, 0, 1.0, 9)
gmsh.model.geo.add_point(0.3, 0.1, 0, 1.0, 10)
gmsh.model.geo.add_line(8, 10, 10)
gmsh.model.geo.add_line(10, 9, 11)
gmsh.model.geo.add_line(9, 7, 12)
gmsh.model.geo.add_line(7, 8, 13)
gmsh.model.geo.add_curve_loop([13, 10, 11, 12], 14)
gmsh.model.geo.add_plane_surface([14], 15)
for i in range(10, 14):
    gmsh.model.geo.mesh.set_transfinite_curve(i, 10)
gmsh.model.geo.mesh.set_transfinite_surface(15)
...
# mesh:
gmsh.option.set_number("Mesh.Smoothing", 100)
