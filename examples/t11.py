...
p1 = gmsh.model.geo.add_point(-1.25, -0.5, 0)
p2 = gmsh.model.geo.add_point(1.25, -0.5, 0)
p3 = gmsh.model.geo.add_point(1.25, 1.25, 0)
p4 = gmsh.model.geo.add_point(-1.25, 1.25, 0)
...
field.set_string(1, "F", "0.01*(1.0+30.*(y-x*x)*(y-x*x) + (1-x)*(1-x))")
field.set_as_background_mesh(1)

# To generate quadrangles instead of triangles, we can simply add
gmsh.model.mesh.set_recombine(2, pl)
