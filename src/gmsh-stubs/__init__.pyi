...
class option:
    ...
    @staticmethod
    def get_color(name: _Name_) -> tuple[int, int, int, int]: ...
    @staticmethod
...
class model:
    ...
    def get_physical_groups_entities(
        dim: _DIM_ = -1,
    ) -> tuple[_DIM_TAGS_, Sequence[_DIM_TAGS_]]: ...
    @staticmethod
    def get_entities_for_physical_group(dim: _DIM_, tag: _TAG_) -> Sequence[int]: ...
    @staticmethod
    def get_entities_for_physical_name(name: str) -> _DIM_TAGS_: ...
    @staticmethod
    def get_physical_groups_for_entity(dim: _DIM_, tag: _TAG_) -> Sequence[int]: ...
    @staticmethod
    def add_physical_group(
        dim: _DIM_, tags: Sequence[int], tag: _TAG_ = -1, name: str = ""
    ) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def get_adjacencies(dim: _DIM_, tag: _TAG_) -> tuple[Sequence[int], Sequence[int]]: ...
    @staticmethod
    ...
    @staticmethod
    def add_discrete_entity(dim: _DIM_, tag: _TAG_ = -1, boundary: Sequence[int] = []) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def get_partitions(dim: _DIM_, tag: _TAG_) -> list[int]: ...
    @staticmethod
    def get_value(dim: _DIM_, tag: _TAG_, parametricCoord: _VectorFloat_) -> list[float]: ...
    @staticmethod
    def get_derivative(dim: _DIM_, tag: _TAG_, parametricCoord: _VectorFloat_) -> list[float]: ...
    @staticmethod
    def get_second_derivative(
        dim: _DIM_, tag: _TAG_, parametricCoord: _VectorFloat_
    ) -> list[float]: ...
    @staticmethod
    def get_curvature(dim: _DIM_, tag: _TAG_, parametricCoord: _VectorFloat_) -> list[float]: ...
    @staticmethod
    ...
    @staticmethod
    def get_parametrization(dim: _DIM_, tag: _TAG_, coord: _VectorFloat_) -> list[float]: ...
    @staticmethod
    def get_parametrization_bounds(dim: _DIM_, tag: _TAG_) -> tuple[list[float], list[float]]: ...
    @staticmethod
    def is_inside(
    ...
    class mesh:
        ...
        @staticmethod
        def get_last_node_error() -> _VectorInt_: ...
        @staticmethod
        ...
        @staticmethod
        def embed(dim: _DIM_, tags: Sequence[int], inDim: int, inTag: int) -> None: ...
        @staticmethod
        ...
        class field:
            ...
            @staticmethod
            def set_numbers(tag: _TAG_, option: _Method_, values: Sequence[int]) -> None: ...
            @staticmethod
    ...
    class occ:
        ...
        @staticmethod
        def add_spline(
            pointTags: Sequence[int], tag: _TAG_ = -1, tangents: Sequence[float] = []
        ) -> _API_RESULT_: ...
        @staticmethod
        def add_bspline(
        ...
        @staticmethod
        def add_bezier(pointTags: Sequence[int], tag: _TAG_ = -1) -> _API_RESULT_: ...
        @staticmethod
        def add_wire(
            curveTags: Sequence[int], tag: _TAG_ = -1, checkClosed: bool = False
        ) -> _API_RESULT_: ...
        @staticmethod
        def add_curve_loop(curveTags: Sequence[int], tag: _TAG_ = -1) -> _API_RESULT_: ...
        @staticmethod
        def add_rectangle(
            x: float,
            y: float,
        ...
        @staticmethod
        def add_plane_surface(wireTags: Sequence[int], tag: _TAG_ = -1) -> _API_RESULT_: ...
        @staticmethod
        def add_surface_filling(
            wireTag: int,
            tag: _TAG_ = -1,
        ...
        def add_trimmed_surface(
            surfaceTag: int, wireTags: Sequence[int] = [], wire3D: bool = False, tag: _TAG_ = -1
        ) -> _API_RESULT_: ...
        @staticmethod
        def add_surface_loop(
            surfaceTags: Sequence[int], tag: _TAG_ = -1, sewing: bool = False
        ) -> _API_RESULT_: ...
        @staticmethod
        def add_volume(shellTags: Sequence[int], tag: _TAG_ = -1) -> _API_RESULT_: ...
        @staticmethod
        def add_sphere(
            xc: float,
            yc: float,
        ...
        ) -> tuple[_DIM_TAGS_, list[float], list[float]]: ...
        @staticmethod
        def fuse(
        ...
        def symmetrize(dimTags: _DIM_TAGS_, a: float, b: float, c: float, d: float) -> None: ...
        @staticmethod
        def affine_transform(dimTags: _DIM_TAGS_, affineTransform: Sequence[float]) -> None: ...
        @staticmethod
        def copy(dimTags: _DIM_TAGS_) -> _DIM_TAGS_: ...
        @staticmethod
        def remove(dimTags: _DIM_TAGS_, *, recursive: bool = False) -> None: ...
        ...
        @staticmethod
        def get_curve_loops(surfaceTag: _TAG_) -> tuple[_Int1D_, Sequence[_Int1D_]]: ...
        @staticmethod
        def get_surface_loops(volumeTag: _TAG_) -> tuple[_Int1D_, Sequence[_Int1D_]]: ...
        @staticmethod
...
class view:
    ...
    @staticmethod
    def get_model_data(tag: _TAG_, step: int) -> tuple[str, list[int], list[float], float, int]: ...
    @staticmethod
...
class fltk:
    ...
    @staticmethod
    def select_elements() -> tuple[int, list[int]]: ...
    @staticmethod
    def select_views() -> tuple[int, list[int]]: ...
    @staticmethod
...
class onelab:
    ...
    @staticmethod
    def get_names(search: str = "") -> list[str]: ...
    @staticmethod
    def set_number(name: str, value: _VectorFloat_) -> None: ...
    @staticmethod
    def set_string(name: str, value: _VectorString_) -> None: ...
    @staticmethod
    def get_number(name: str) -> list[float]: ...
    @staticmethod
    def get_string(name: str) -> list[str]: ...
    @staticmethod
